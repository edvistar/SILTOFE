        ...
        <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <form action="../../controller/admin/insertarProducto.php" id="loginForm" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" name="solicitud" class="form-control" required>
                            </div>
                            <div class="form-group col-lg-12">
