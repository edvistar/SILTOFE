    ...
    <div class="row">
        ...
        <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
            <div class="text-center custom-login mt-20px">
                <h3 class="registro-usuario">REGISTRO DE VEHICULO</h3>
                <p>Todos los campos son obligatorios</p>
            </div>
            <div class="hpanel">
                <div class="panel-body">
                    <form action="../../controller/admin/insertarVehiculo.php" id="loginForm" method="post" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="number" name="costo_flete" class="form-control" >
                            </div>
                            <div class="form-group col-lg-12">
                                <label>GPS</label>
